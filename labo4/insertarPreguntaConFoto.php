...
?>	
	...
	<input type="button" name="ver" value="Ver preguntas (DB)" id="ver">
	<input type="button" name="verXML" value="Ver preguntas (XML)" id="verXML">
	...
	$("#verXML").click(function(){			
		window.location ="VerPreguntasXML.php";			
		});
